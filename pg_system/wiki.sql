...
CREATE DOMAIN content_type AS text NOT NULL;


ALTER DOMAIN content_type OWNER TO wiki;
...
ALTER DOMAIN id OWNER TO wiki;

--
-- Name: link_reftype; Type: TYPE; Schema: wiki; Owner: wiki
--

CREATE TYPE link_reftype AS ENUM (
    'href',
    'src'
);


ALTER TYPE link_reftype OWNER TO wiki;
...
ALTER TYPE namespace OWNER TO wiki;
...
ALTER DOMAIN nid OWNER TO wiki;

--
-- Name: result; Type: DOMAIN; Schema: wiki; Owner: wiki
--

CREATE DOMAIN result AS xml;


ALTER DOMAIN result OWNER TO wiki;
...
ALTER DOMAIN url OWNER TO wiki;

--
-- Name: wiki_type; Type: DOMAIN; Schema: wiki; Owner: wiki
--

CREATE DOMAIN wiki_type AS text;


ALTER DOMAIN wiki_type OWNER TO wiki;

--
-- Name: foreign_page_get(text, text); Type: FUNCTION; Schema: wiki; Owner: wiki
--

CREATE FUNCTION foreign_page_get(wiki text, title text) RETURNS text
    LANGUAGE plperlu
...
CREATE FUNCTION foreign_pages_search(wiki text, title text) RETURNS SETOF text
    LANGUAGE plperlu
...
CREATE FUNCTION html_entities(text) RETURNS text
...
CREATE FUNCTION html_tidy(text) RETURNS xml
...
CREATE FUNCTION is_xml(regtype) RETURNS boolean
...
CREATE FUNCTION nid_body() RETURNS nid
    LANGUAGE sql
...
CREATE FUNCTION nid_page() RETURNS nid
    LANGUAGE sql
...
CREATE FUNCTION nid_rev() RETURNS nid
    LANGUAGE sql
...
CREATE FUNCTION node_before_trigger() RETURNS trigger
    LANGUAGE plpgsql
    AS $_$
declare
 body_id2 wiki.nid;
...
CREATE FUNCTION node_links_trigger() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
  if wiki.is_xml(new.page_regtype) then
...
--
-- Name: node_links_update(nid, xml); Type: FUNCTION; Schema: wiki; Owner: wiki
--

CREATE FUNCTION node_links_update(my_page_id nid, body xml, OUT link_url text, OUT link_reftype link_reftype, OUT link_action text) RETURNS SETOF record
...
ALTER FUNCTION wiki.node_links_update(my_page_id nid, body xml, OUT link_url text, OUT link_reftype link_reftype, OUT link_action text) OWNER TO wiki;

--
-- Name: page_extract_links(xml); Type: FUNCTION; Schema: wiki; Owner: wiki
--

CREATE FUNCTION page_extract_links(body xml, OUT reftype link_reftype, OUT url text) RETURNS SETOF record
...
ALTER FUNCTION wiki.page_extract_links(body xml, OUT reftype link_reftype, OUT url text) OWNER TO wiki;

--
-- Name: FUNCTION page_extract_links(body xml, OUT reftype link_reftype, OUT url text); Type: COMMENT; Schema: wiki; Owner: wiki
--

COMMENT ON FUNCTION page_extract_links(body xml, OUT reftype link_reftype, OUT url text) IS 'Extract links from (X)HTML';
...
CREATE FUNCTION page_get(full_title text) RETURNS text
    LANGUAGE plpgsql
    AS $$
declare
 r record;
...
--
-- Name: page_get(nid); Type: FUNCTION; Schema: wiki; Owner: wiki
--

CREATE FUNCTION page_get(my_page_id nid) RETURNS text
    LANGUAGE plpgsql
    AS $_$
declare
 r record;
...
ALTER FUNCTION wiki.page_get(my_page_id nid) OWNER TO wiki;

--
-- Name: page_get(text, nid); Type: FUNCTION; Schema: wiki; Owner: wiki
--

CREATE FUNCTION page_get(full_title text, my_rev_id nid) RETURNS text
    LANGUAGE plpgsql
    AS $$
declare
 t record;
...
ALTER FUNCTION wiki.page_get(full_title text, my_rev_id nid) OWNER TO wiki;

--
-- Name: page_get_data(text); Type: FUNCTION; Schema: wiki; Owner: wiki
--

CREATE FUNCTION page_get_data(full_title text) RETURNS json
    LANGUAGE plpgsql
    AS $$
declare
 r record;
...
--
-- Name: page_get_data(text, nid); Type: FUNCTION; Schema: wiki; Owner: wiki
--

CREATE FUNCTION page_get_data(full_title text, my_rev_id nid) RETURNS json
    LANGUAGE plpgsql
    AS $$
declare
 t record;
...
ALTER FUNCTION wiki.page_get_data(full_title text, my_rev_id nid) OWNER TO wiki;

--
-- Name: page_set(text, json); Type: FUNCTION; Schema: wiki; Owner: wiki
--

CREATE FUNCTION page_set(full_title text, new_body json) RETURNS nid
...
CREATE FUNCTION page_set(full_title text, new_body text) RETURNS nid
    LANGUAGE plpgsql STRICT
    AS $$
declare
 r record;
...
CREATE FUNCTION page_set(full_title text, new_body xml) RETURNS nid
    LANGUAGE plpgsql STRICT
    AS $$
declare
 r record;
...
CREATE FUNCTION page_set_with_options(full_title text, new_body text, mysession json) RETURNS nid
    LANGUAGE plpgsql STRICT
    AS $$
declare
 r record;
...
CREATE FUNCTION proc_get_info(proc_name text, OUT proc_oid oid, OUT sql_identifier text, OUT argnames text[], OUT argtypes text[], OUT comment text, OUT has_http_acl boolean) RETURNS SETOF record
    LANGUAGE plpgsql
    AS $$
declare 
 p  record;
...
COMMENT ON FUNCTION proc_get_info(proc_name text, OUT proc_oid oid, OUT sql_identifier text, OUT argnames text[], OUT argtypes text[], OUT comment text, OUT has_http_acl boolean) IS 'Inquire about a function';
...
CREATE FUNCTION special_all_pages(OUT content xml) RETURNS SETOF xml
    LANGUAGE sql
    AS $$
with a as (
select 
...
CREATE FUNCTION special_new_pages(OUT content xml) RETURNS SETOF xml
    LANGUAGE sql
    AS $$
with a as (
select 
...
CREATE FUNCTION special_recent_changes(OUT content xml) RETURNS SETOF xml
    LANGUAGE sql
    AS $$
with a as (
select 
...
CREATE FUNCTION title_parse(full_title text, OUT namespace namespace, OUT title text) RETURNS record
...
ALTER FUNCTION wiki.title_parse(full_title text, OUT namespace namespace, OUT title text) OWNER TO wiki;

--
-- Name: wiki_id(); Type: FUNCTION; Schema: wiki; Owner: wiki
--

CREATE FUNCTION wiki_id() RETURNS id
    LANGUAGE sql
...
--
-- Name: wiki; Type: TABLE; Schema: wiki; Owner: wiki; Tablespace: 
--

CREATE TABLE wiki (
    wiki_id id DEFAULT wiki_id() NOT NULL,
    wiki_name text NOT NULL,
    wiki_type wiki_type DEFAULT 'mediawiki'::text,
    wiki_version text,
    wiki_url url NOT NULL,
    wiki_username text,
    wiki_password text,
    wiki_api url,
    wiki_upload url
...
ALTER TABLE wiki OWNER TO wiki;

--
-- Name: wiki(text); Type: FUNCTION; Schema: wiki; Owner: wiki
--

CREATE FUNCTION wiki(name text) RETURNS wiki
    LANGUAGE sql
...
--
-- Name: body; Type: TABLE; Schema: wiki; Owner: wiki; Tablespace: 
--

CREATE TABLE body (
    body_id nid DEFAULT nid_body() NOT NULL,
    body_text text,
    body_vector tsvector
);


ALTER TABLE body OWNER TO wiki;

--
-- Name: TABLE body; Type: COMMENT; Schema: wiki; Owner: wiki
--

COMMENT ON TABLE body IS 'Node text bodies and their search vectors';


--
-- Name: links; Type: TABLE; Schema: wiki; Owner: wiki; Tablespace: 
--

CREATE TABLE links (
    link_from nid NOT NULL,
    link_to nid,
    link_reftype link_reftype NOT NULL,
    link_url url NOT NULL
);


ALTER TABLE links OWNER TO wiki;

--
-- Name: nid_body_seq; Type: SEQUENCE; Schema: wiki; Owner: wiki
--

CREATE SEQUENCE nid_body_seq
    START WITH 15
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE nid_body_seq OWNER TO wiki;

--
-- Name: nid_page_seq; Type: SEQUENCE; Schema: wiki; Owner: wiki
--

CREATE SEQUENCE nid_page_seq
    START WITH 15
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE nid_page_seq OWNER TO wiki;

--
-- Name: nid_rev_seq; Type: SEQUENCE; Schema: wiki; Owner: wiki
--

CREATE SEQUENCE nid_rev_seq
    START WITH 15
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE nid_rev_seq OWNER TO wiki;
...
ALTER TABLE nid_seq OWNER TO wiki;

--
-- Name: node; Type: TABLE; Schema: wiki; Owner: wiki; Tablespace: 
--

CREATE TABLE node (
    page_id nid DEFAULT nid_page() NOT NULL,
    page_namespace namespace DEFAULT 'main'::namespace NOT NULL,
...
ALTER TABLE node OWNER TO wiki;

--
-- Name: revision; Type: TABLE; Schema: wiki; Owner: wiki; Tablespace: 
--

CREATE TABLE revision (
    rev_id nid DEFAULT nid_rev() NOT NULL,
    page_id nid NOT NULL,
    body_id nid NOT NULL,
...
ALTER TABLE revision OWNER TO wiki;
...
CREATE VIEW page AS
 SELECT n.rev_id,
   ...
   FROM (node n
     JOIN revision r USING (rev_id, page_id));


ALTER TABLE page OWNER TO wiki;
...
ALTER TABLE wiki_seq OWNER TO wiki;

--
-- Name: body_pkey; Type: CONSTRAINT; Schema: wiki; Owner: wiki; Tablespace: 
--
...
--
-- Name: links_pkey; Type: CONSTRAINT; Schema: wiki; Owner: wiki; Tablespace: 
--
...
--
-- Name: page_page_namespace_page_title_key; Type: CONSTRAINT; Schema: wiki; Owner: wiki; Tablespace: 
--
...
--
-- Name: page_pkey; Type: CONSTRAINT; Schema: wiki; Owner: wiki; Tablespace: 
--
...
--
-- Name: revision_pkey; Type: CONSTRAINT; Schema: wiki; Owner: wiki; Tablespace: 
--
...
--
-- Name: wikis_pkey; Type: CONSTRAINT; Schema: wiki; Owner: wiki; Tablespace: 
--
...
--
-- Name: wikis_wiki_name_key; Type: CONSTRAINT; Schema: wiki; Owner: wiki; Tablespace: 
--
...
--
-- Name: page_biud; Type: TRIGGER; Schema: wiki; Owner: wiki
--

CREATE TRIGGER page_biud BEFORE INSERT OR DELETE OR UPDATE ON node FOR EACH ROW EXECUTE PROCEDURE node_before_trigger();


--
-- Name: page_links_ai; Type: TRIGGER; Schema: wiki; Owner: wiki
--

CREATE TRIGGER page_links_ai AFTER INSERT ON node FOR EACH ROW WHEN (is_xml(new.page_regtype)) EXECUTE PROCEDURE node_links_trigger();


--
-- Name: page_links_au; Type: TRIGGER; Schema: wiki; Owner: wiki
--

CREATE TRIGGER page_links_au AFTER UPDATE ON node FOR EACH ROW WHEN ((is_xml(new.page_regtype) AND (old.* IS DISTINCT FROM new.*))) EXECUTE PROCEDURE node_links_trigger();


--
-- Name: links_link_from_fkey; Type: FK CONSTRAINT; Schema: wiki; Owner: wiki
--

ALTER TABLE ONLY links
    ADD CONSTRAINT links_link_from_fkey FOREIGN KEY (link_from) REFERENCES node(page_id);


--
-- Name: links_link_to_fkey; Type: FK CONSTRAINT; Schema: wiki; Owner: wiki
--

ALTER TABLE ONLY links
    ADD CONSTRAINT links_link_to_fkey FOREIGN KEY (link_to) REFERENCES node(page_id);


--
-- Name: page_rev_id_fkey; Type: FK CONSTRAINT; Schema: wiki; Owner: wiki
--

ALTER TABLE ONLY node
    ADD CONSTRAINT page_rev_id_fkey FOREIGN KEY (rev_id) REFERENCES revision(rev_id);


--
-- Name: revision_body_id_fkey; Type: FK CONSTRAINT; Schema: wiki; Owner: wiki
--

ALTER TABLE ONLY revision
    ADD CONSTRAINT revision_body_id_fkey FOREIGN KEY (body_id) REFERENCES body(body_id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: revision_page_id_fkey; Type: FK CONSTRAINT; Schema: wiki; Owner: wiki
--

ALTER TABLE ONLY revision
    ADD CONSTRAINT revision_page_id_fkey FOREIGN KEY (page_id) REFERENCES node(page_id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: wiki; Type: ACL; Schema: -; Owner: wiki
--

REVOKE ALL ON SCHEMA wiki FROM PUBLIC;
REVOKE ALL ON SCHEMA wiki FROM wiki;
GRANT ALL ON SCHEMA wiki TO wiki;
GRANT USAGE ON SCHEMA wiki TO PUBLIC;


--
-- Name: proc_get_info(text); Type: ACL; Schema: wiki; Owner: wiki
--

REVOKE ALL ON FUNCTION proc_get_info(proc_name text, OUT proc_oid oid, OUT sql_identifier text, OUT argnames text[], OUT argtypes text[], OUT comment text, OUT has_http_acl boolean) FROM PUBLIC;
REVOKE ALL ON FUNCTION proc_get_info(proc_name text, OUT proc_oid oid, OUT sql_identifier text, OUT argnames text[], OUT argtypes text[], OUT comment text, OUT has_http_acl boolean) FROM wiki;
GRANT ALL ON FUNCTION proc_get_info(proc_name text, OUT proc_oid oid, OUT sql_identifier text, OUT argnames text[], OUT argtypes text[], OUT comment text, OUT has_http_acl boolean) TO wiki;
GRANT ALL ON FUNCTION proc_get_info(proc_name text, OUT proc_oid oid, OUT sql_identifier text, OUT argnames text[], OUT argtypes text[], OUT comment text, OUT has_http_acl boolean) TO PUBLIC;


--
-- Name: body; Type: ACL; Schema: wiki; Owner: wiki
--

REVOKE ALL ON TABLE body FROM PUBLIC;
REVOKE ALL ON TABLE body FROM wiki;
GRANT ALL ON TABLE body TO wiki;
GRANT SELECT ON TABLE body TO PUBLIC;


--
-- Name: node; Type: ACL; Schema: wiki; Owner: wiki
--

REVOKE ALL ON TABLE node FROM PUBLIC;
REVOKE ALL ON TABLE node FROM wiki;
GRANT ALL ON TABLE node TO wiki;
GRANT SELECT ON TABLE node TO PUBLIC;


--
-- Name: revision; Type: ACL; Schema: wiki; Owner: wiki
--

REVOKE ALL ON TABLE revision FROM PUBLIC;
REVOKE ALL ON TABLE revision FROM wiki;
GRANT ALL ON TABLE revision TO wiki;
GRANT SELECT ON TABLE revision TO PUBLIC;


--
-- Name: page; Type: ACL; Schema: wiki; Owner: wiki
--

REVOKE ALL ON TABLE page FROM PUBLIC;
REVOKE ALL ON TABLE page FROM wiki;
GRANT ALL ON TABLE page TO wiki;
